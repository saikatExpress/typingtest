...
<body style="background-color: £fff;">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('welcome') }}">
                    <span class="md:text-xl text-lg">
                        <img style="width: 70px;height: 70px;border-radius: 50%;box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;"
    ...
    <h2
        ...
        <a href="">
            <img src="https://readme-typing-svg.herokuapp.com?font=roboto&weight=900&size=50&pause=1000&color=02668D&width=520&height=80&lines=+Bengali+Typing+Test"
                alt="Typing SVG" />
        </a>
    ...
    <div class="px-4">
        <div class="bg-gradient-to-r rounded-md shadow-md from-[#2BBCE3] to-[#2BBCE3] max-w-[1100px] mx-auto h-[500px]">
            <p class="p-4 md:text-[16px] text-[13px] font-semibold text-center text-gray-900">
                Preparing for Bengali typing test. Check your Typing speed in Bengali. The Free online Bengali Typing
                Test will show your Typing Speed in WPM and Accuracy. You can take more test to practise the exam you
                have to crack, This can be use as a Speed Improve Software for Bengali Typing. The World's First & Only
                Typing Test Software for Bengali Language.
            </p>
